...
public class Docx4JDemo {
	...
	public void test() {
		...
		try {
			wordMLPackage = WordprocessingMLPackage
					.load(new java.io.File("d://s7_simple.docx"));
	...
	public static void main(String[] args) throws Exception {
		...
		t.createParagraghLine(wordMLPackage, mp, factory, paragraph, topBorder,
				topBorder, topBorder, topBorder);
		mp.addObject(paragraph);
		t.createHyperlink(wordMLPackage, mp, factory, paragraph,
				"mailto:1329186624@qq.com?subject=docx4j测试", "联系我", "微软雅黑",
				"24", JcEnumeration.CENTER);
		...
		t.saveWordPackage(wordMLPackage, new File("d:/s7_simple.docx"));
	}
	...
	public void createParagraghLine(WordprocessingMLPackage wordMLPackage,
			MainDocumentPart t, ObjectFactory factory, P p, CTBorder topBorder,
			CTBorder bottomBorder, CTBorder leftBorder, CTBorder rightBorder) {
		PPr ppr = new PPr();
		PBdr pBdr = new PBdr();
	...
	public void createHyperlink(WordprocessingMLPackage wordMLPackage,
			...
			String value, String fontName, String fontSize,
			JcEnumeration jcEnumeration) throws Exception {
